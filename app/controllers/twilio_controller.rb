...
SEAN = '+13057266671'
  ...
  def index
    ...
    def ivr_welcome
      ...
      message = 'Please listen to the following options, as our menu has changed. For sthe meat department, press 1. For Customer service, press 2. Product, 3. Flowers, 4. Manager, 4.'
